...
#ifndef __N_STEPS_KM_HPP__
#define __N_STEPS_KM_HPP__
...
private:
  ...
  //@{
  //  NStepsKM();
  NStepsKM(const NStepsKM&);
  NStepsKM& operator=(const NStepsKM&);
  //@}
};

#endif /* __N_STEPS_KM_HPP__ */