#ifndef IPOPT_MPC_ONE_STEP_H
#define IPOPT_MPC_ONE_STEP_H
...
class IpoptMPCOneStep : public Ipopt::TNLP 
{
  public:
    /** defualt constructor **/
  ...
  private:
    ...
    //@{
    //  IpoptMPC();
    IpoptMPCOneStep(const IpoptMPCOneStep&);
    IpoptMPCOneStep& operator=(const IpoptMPCOneStep&);
    //@}    
